...
class FormapagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formapago" do
    assert_difference('Formapago.count') do
      post formapagos_url, params: { formapago: { abreviacion: @formapago.abreviacion, activo: @formapago.activo, descripcion: @formapago.descripcion } }, as: :json
    end
  ...
  test "should update formapago" do
    patch formapago_url(@formapago), params: { formapago: { abreviacion: @formapago.abreviacion, activo: @formapago.activo, descripcion: @formapago.descripcion } }, as: :json
    assert_response 200
  end
